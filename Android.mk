...
RECOVERY_NAME := CWM-based Recovery - CD
endif
...
# DroidBoot symlinks
DROIDBOOT_LINKS := droidboot
RECOVERY_DROIDBOOT_SYMLINKS := $(addprefix $(TARGET_RECOVERY_ROOT_OUT)/sbin/,$(DROIDBOOT_LINKS))
$(RECOVERY_DROIDBOOT_SYMLINKS): RECOVERY_BINARY := $(LOCAL_MODULE)
$(RECOVERY_DROIDBOOT_SYMLINKS): $(LOCAL_INSTALLED_MODULE)
	@echo "Symlink: $@ -> $(RECOVERY_BINARY)"
	@mkdir -p $(dir $@)
	@rm -rf $@
	$(hide) ln -sf $(RECOVERY_BINARY) $@

ALL_DEFAULT_INSTALLED_MODULES += $(RECOVERY_DROIDBOOT_SYMLINKS) 
